...
#ifndef cephes_math_H__
#define cephes_math_H__
...
#define _PI32_CONST(Name, Val) \
	static const int _pi32_##Name[4] __attribute__ ((aligned(16))) = { (int)(Val), (int)(Val), (int)(Val), (int)(Val) }
#define _PS_CONST_INT(Name, Val) \
	static const int _ps_##Name[4]   __attribute__ ((aligned(16))) = { (int)(Val), (int)(Val), (int)(Val), (int)(Val) }

#else
#define _PS_CONST(Name, Val) \
	static const float __declspec (align(16)) _ps_##Name[4] = { Val, Val, Val, Val }
#define _PI32_CONST(Name, Val) \
	static const int __declspec (align(16)) _pi32_##Name[4] = { (int)(Val), (int)(Val), (int)(Val), (int)(Val) }
#define _PS_CONST_INT(Name, Val) \
	static const int __declspec (align(16)) _ps_##Name[4]   = { (int)(Val), (int)(Val), (int)(Val), (int)(Val) }
...
inline v4sf cephes_pow(const v4sf x, const v4sf y) {
	const v4sf zero_filter = _mm_cmpeq_ps(x, _mm_setzero_ps());
	return _mm_andnot_ps(zero_filter, cephes_exp(_mm_mul_ps(cephes_log(x), y)));
}
